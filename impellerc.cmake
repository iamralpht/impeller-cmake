...
function(add_shader)
    ...
    list(APPEND ARG_INCLUDES "${INPUT_DIRECTORY}")
    ...
    impellerc(
        ...
        REFLECTION_HEADER ${ARG_OUTPUT_DIR}/${INPUT_FILENAME}_GLES_THROWAWAY.h
    ...
    list(FILTER METAL_ARG_UNPARSED_ARGUMENTS EXCLUDE REGEX "OPENGL_ES")
    impellerc(
        INPUT ${ARG_INPUT}
    ...
    # Ensure we run the Metal rule when referencing the OpenGL ES generated
    # code.
    set_property(SOURCE
