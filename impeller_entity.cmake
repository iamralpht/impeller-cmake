...
add_gles_shader_library(
    ...
    SHADERS
      ...
      ${IMPELLER_ENTITY_DIR}/shaders/glyph_atlas_sdf.vert
      ...
      ${IMPELLER_ENTITY_DIR}/shaders/position_uv.vert
      ...
      ${IMPELLER_ENTITY_DIR}/shaders/tiled_texture_fill.vert
...
add_library(entity_shaders_lib STATIC
    "${GENERATED_DIR}/impeller/entity/gles/entity_shaders_gles.c"
    "${GENERATED_DIR}/impeller/entity/advanced_blend.vert.cc"
    "${GENERATED_DIR}/impeller/entity/advanced_blend_color.frag.cc"
    "${GENERATED_DIR}/impeller/entity/advanced_blend_colorburn.frag.cc"
    "${GENERATED_DIR}/impeller/entity/advanced_blend_colordodge.frag.cc"
    "${GENERATED_DIR}/impeller/entity/advanced_blend_darken.frag.cc"
    "${GENERATED_DIR}/impeller/entity/advanced_blend_difference.frag.cc"
    "${GENERATED_DIR}/impeller/entity/advanced_blend_exclusion.frag.cc"
    "${GENERATED_DIR}/impeller/entity/advanced_blend_hardlight.frag.cc"
    "${GENERATED_DIR}/impeller/entity/advanced_blend_hue.frag.cc"
    "${GENERATED_DIR}/impeller/entity/advanced_blend_lighten.frag.cc"
    "${GENERATED_DIR}/impeller/entity/advanced_blend_luminosity.frag.cc"
    "${GENERATED_DIR}/impeller/entity/advanced_blend_multiply.frag.cc"
    "${GENERATED_DIR}/impeller/entity/advanced_blend_overlay.frag.cc"
    "${GENERATED_DIR}/impeller/entity/advanced_blend_saturation.frag.cc"
    "${GENERATED_DIR}/impeller/entity/advanced_blend_screen.frag.cc"
    "${GENERATED_DIR}/impeller/entity/advanced_blend_softlight.frag.cc"
    "${GENERATED_DIR}/impeller/entity/blend.frag.cc"
    "${GENERATED_DIR}/impeller/entity/blend.vert.cc"
    "${GENERATED_DIR}/impeller/entity/border_mask_blur.frag.cc"
    "${GENERATED_DIR}/impeller/entity/border_mask_blur.vert.cc"
    ...
    "${GENERATED_DIR}/impeller/entity/glyph_atlas_sdf.vert.cc"
    "${GENERATED_DIR}/impeller/entity/gradient_fill.vert.cc"
    "${GENERATED_DIR}/impeller/entity/linear_to_srgb_filter.frag.cc"
    "${GENERATED_DIR}/impeller/entity/linear_to_srgb_filter.vert.cc"
    "${GENERATED_DIR}/impeller/entity/linear_gradient_fill.frag.cc"
    "${GENERATED_DIR}/impeller/entity/morphology_filter.frag.cc"
    "${GENERATED_DIR}/impeller/entity/morphology_filter.vert.cc"
    "${GENERATED_DIR}/impeller/entity/position_color.vert.cc"
    "${GENERATED_DIR}/impeller/entity/position_uv.vert.cc"
    "${GENERATED_DIR}/impeller/entity/radial_gradient_fill.frag.cc"
    "${GENERATED_DIR}/impeller/entity/rrect_blur.vert.cc"
    "${GENERATED_DIR}/impeller/entity/rrect_blur.frag.cc"
    "${GENERATED_DIR}/impeller/entity/runtime_effect.vert.cc"
    "${GENERATED_DIR}/impeller/entity/solid_fill.frag.cc"
    "${GENERATED_DIR}/impeller/entity/solid_fill.vert.cc"
    "${GENERATED_DIR}/impeller/entity/srgb_to_linear_filter.frag.cc"
    "${GENERATED_DIR}/impeller/entity/srgb_to_linear_filter.vert.cc"
    "${GENERATED_DIR}/impeller/entity/sweep_gradient_fill.frag.cc"
    "${GENERATED_DIR}/impeller/entity/texture_fill.frag.cc"
    "${GENERATED_DIR}/impeller/entity/texture_fill.vert.cc"
    "${GENERATED_DIR}/impeller/entity/tiled_texture_fill.frag.cc"
    "${GENERATED_DIR}/impeller/entity/tiled_texture_fill.vert.cc"
    "${GENERATED_DIR}/impeller/entity/vertices.frag.cc"
    "${GENERATED_DIR}/impeller/entity/yuv_to_rgb_filter.frag.cc"
    "${GENERATED_DIR}/impeller/entity/yuv_to_rgb_filter.vert.cc")

#link_libraries(entity_shaders_lib PUBLIC impeller_renderer impeller_image)
...
#link_libraries(modern_shaders_lib PUBLIC impeller_renderer impeller_image)
...
#link_libraries(framebuffer_blend_shaders_lib PUBLIC impeller_renderer impeller_image)
